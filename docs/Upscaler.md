...
The pcitures you upload to Smart Upscaler can't be seen by others. 
You can delete uploaded images right inside the tool, but you will be able to access them with a direct link within the next 60 days. After two months pass, the images get deleted permanently.
